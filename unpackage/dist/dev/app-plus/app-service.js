  ...
  const useHomeStore = defineStore("home", {
    ...
    actions: {
      ...
      async reqRefreshLogin() {
        ...
        formatAppLog("log", "at store/home.js:26", res);
      },
          ...
          vue.createElementVNode("view", { class: "video_container" }, [
            vue.createElementVNode("view", { class: "header" }, [
              ...
              vue.createElementVNode("input", {
                type: "text",
                placeholder: "\u8F93\u5165\u641C\u7D22\u5173\u952E\u5B57",
                "placeholder-style": "color:yellowgreen;font-size:24rpx",
                focus: "{{true}}"
              }),
              vue.createElementVNode("image", {
                src: "/static/c6.png",
              ...
              vue.createVNode(_component_uni_col, {
                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("view", {
                    ...
                    vue.createElementVNode("image", {
                      class: "avatar",
                      src: vue.unref(account).status == 0 ? vue.unref(profile).avatarUrl : "../../static/logo.png"
                    }, null, 8, ["src"]),
                    vue.createElementVNode("text", null, vue.toDisplayString(vue.unref(account).status == 0 ? vue.unref(profile).nickname : "\u672A\u767B\u5F55"), 1)
                  ])
                ]),
                _: 1
              })
            ...
            vue.createElementVNode("view", { class: "user" }, [
              ...
              vue.createVNode(_component_uni_row, null, {
                default: vue.withCtx(() => [
                  ...
                  vue.createVNode(_component_uni_col, null, {
                    default: vue.withCtx(() => [
                      vue.createElementVNode("button", { onClick: back }, "\u53D6\u6D88")
                    ]),
                    _: 1
                  })
                ]),
